...
{
    m_texmgr.setLocalUserId( pUserID );
...
int YouMeTalk::setHeadsetMonitorOn( bool micEnabled, bool bgmEnabled )
{
	return (YouMeErrorCode)(getInf()->setHeadsetMonitorOn(micEnabled, bgmEnabled ));
}

int YouMeTalk::setReverbEnabled(bool enabled)
{
	return (YouMeErrorCode)(getInf()->setReverbEnabled(enabled));
}
